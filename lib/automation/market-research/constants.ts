...
export const DEFAULT_PUBLIC_MAX = Number.parseInt(process.env.MARKET_RESEARCH_PUBLIC_MAX || "8", 10) || 8;
export const DEFAULT_INSTITUTION_MAX_PER_ORG =
  Number.parseInt(process.env.MARKET_RESEARCH_INSTITUTION_MAX_PER_ORG || "3", 10) || 3;

export const OPENAI_CALL_TIMEOUT_MS =
  Number.parseInt(process.env.MARKET_RESEARCH_CALL_TIMEOUT_MS || "120000", 10) || 120_000;
export const RUN_TIMEOUT_MS =
  Number.parseInt(process.env.MARKET_RESEARCH_RUN_TIMEOUT_MS || "480000", 10) || 480_000;
