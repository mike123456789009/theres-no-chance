...
export default async function WalletPage({ searchParams }: Readonly<{ searchParams?: SearchParamsInput }>) {
  if (!isSupabaseServerEnvConfigured()) {
    ...
    return (
      <main className="create-page">
        <section className="create-card create-card-warning" aria-label="Wallet configuration error">
  ...
  if (authError || !user) {
    return (
      <main className="create-page">
        <section className="create-card" aria-label="Wallet login required">
          <p className="create-kicker">Wallet</p>
  ...
  return (
    <main className="create-page">
      <section className="create-card" aria-label="Wallet overview">
        <p className="create-kicker">Wallet</p>
        ...
        <div className="create-actions" style={{ marginTop: "0.8rem" }}>
          ...
          <a className="create-submit create-submit-muted" href="/">
            Home
          </a>
        </div>
